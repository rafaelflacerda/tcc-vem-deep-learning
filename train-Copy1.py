...
def main(args):
    ...
    print("best_val_sobolev_loss;best_val_w_mse;epoch_of_best_val;final_val_sobolev_loss;final_val_w_mse")
    print(f"{best_val_sobolev_loss};{best_val_w_mse};{epoch_of_best_val};{final_val_sobolev_loss};{final_val_w_mse}")
